...
Since we need to repeat our data preparation for both sets, it makes sense to construct a function. ```prepCountList()``` will prepare a ranked list our our terms, sorted by frequency. 
